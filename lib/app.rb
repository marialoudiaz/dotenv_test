...
#connexion à twitter # imbriqué dans une methode login > return client
...
#client.update('From Maria - Howdy, world !')
...
5.times do
  journalists = arr.sample
  puts journalists
  client.update ("Thank you for your service! #bonjour_monde #{journalists}")

end
#print "Thank you for your service to the democracy #bonjour_monde"
#------------- autre idée 
...
#liker les 25 derniers tweets utilisant #bonjour_monde
#tweets = client.search("#bonjour_monde", result_type: "recent").take(25)
#client.favorite(tweets)
# client.update - envoie le tweet

#follow bonjour - follow les dernières personnes (min 20) ont tweeté avec le hashtag #bonjour_monde
tweets = client.search("#bonjour_monde", result_type: "recent").take(20).map do |tweet|
client.follow (tweet.user)
client.update #- envoie le tweet



#like+follow comptes tweetant #bonjour_monde - fonction streaming de l'API Twitter : réagir en live

#mettre des puts dès que tu repères un Tweet (pour qu'il apparaisse sur ton terminal)